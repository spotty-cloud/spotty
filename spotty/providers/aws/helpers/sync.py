...
def sync_project_with_s3(local_project_dir, bucket_name, region, sync_filters, dry_run=False):
...
def sync_instance_with_s3(project_s3_path, instance_project_dir, sync_filters: list, host: str, port: int, user: str,
                          key_path: str):
    ...
    remote_cmd = subprocess.list2cmdline(['sudo', '-i', 'aws', 's3', 'sync', project_s3_path, instance_project_dir,
